...
struct GitHubSearchRepositoriesState {
    ...
    var repositories: Version<[Repository]> // Version is an optimization. When somethig unrelated changes, we don't want to reload table view.
    var nextURL: URL?
...
func githubSearchRepositories(
    ...
    let searchPerformerFeedback: (Driver<GitHubSearchRepositoriesState>) -> Driver<GitHubCommand> = { state in
        ...
        // first select part of state describing feedback constol
        ...
        // perform feeedback loop effects

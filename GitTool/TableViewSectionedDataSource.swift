...
//
//  Based: https://github.com/ReactiveX/RxSwift/blob/a778b10f94f82d37af6ae441372a23154044dab4/RxExample/RxDataSources/DataSources/TableViewSectionedDataSource.swift
...
open class _TableViewSectionedDataSource: NSObject, UITableViewDataSource {
...
open class TableViewSectionedDataSource<S: SectionModelType>: _TableViewSectionedDataSource, SectionedViewDataSourceType {
    ...
    // This simulatesimmutability after binding
    ...
    // If particular item is mutable, that is irrelevant for this logic to function properly.

...
class GTLTopViewController: ViewController, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        state
            ...
            .filter { $0 }
            .drive(onNext: { n in
                showAlert("Exceed limit of 10 non authenticated requests per minute for GitHubAPI. Please wait a minutes:(\nhttps://developer.github.com/v3/#rate-limiting")
            })
            .disposed(by: disposeBag)
